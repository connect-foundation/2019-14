...
const TerminalImage = (imagePath, index, props = TerminalImage.defaultProps) => {
  return <TerminalImg src={imagePath} alt={props.terminalEnvironment} draggable={props.isDragabble} key={index} />;
};
